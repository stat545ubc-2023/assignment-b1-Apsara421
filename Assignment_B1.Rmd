...
```{r}
#Example of code I repreaded a lot in my analysis
...
```
Example 3: To show an error incase the user inputs a numerical categorical variabe that is not acually numeric
```{r}
error=TRUE
